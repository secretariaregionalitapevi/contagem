...
function processSummary(summaryDataString) {
  try {
    ...
    const ministerioCargos = [
      'Anciães', 'Diáconos', 'Irmãs da Obra da Piedade', 'Cooperadores do Ofício Ministerial',
      ...
      if (cargo === 'Ministério' && ministerio) {
        ...
        switch (ministerio) {
          ...
          case 'Diácono':
            categoria = 'Diácono';
            break;
          case 'Irmãs da Obra da Piedade':
          case 'Irmã da Piedade':
          case 'Irmãs da Piedade':
            categoria = 'Irmãs da Obra da Piedade';
            break;
